export const getEditEventTemplate = ({type, city, price, description, start, end, offers, urls}, typesOfTransfer, typesOfActivity, cities, options) =>
...
<form class="event  event--edit" action="#" method="post">
  <header class="event__header">
    <div class="event__type-wrapper">
      ...
      ${typesOfTransfer.map((transferType) => `<div class="event__type-item">
    ...
    <fieldset class="event__type-group">
      ...
      ${typesOfActivity.map((activityType) => `<div class="event__type-item">
  ...
  <input class="event__input  event__input--time" id="event-start-time-1" type="text" name="event-start-time" value="${start.toString().slice(4, 21)}">
  &mdash;
  <label class="visually-hidden" for="event-end-time-1">
    To
  </label>
  <input class="event__input  event__input--time" id="event-end-time-1" type="text" name="event-end-time" value="${end.toString().slice(4, 21)}">
</div>
